...
#define LPSYS_CFG_SYSCR_RESERVE0_Pos    (0U)
#define LPSYS_CFG_SYSCR_RESERVE0_Msk    (0xFFUL << LPSYS_CFG_SYSCR_RESERVE0_Pos)
#define LPSYS_CFG_SYSCR_RESERVE0        LPSYS_CFG_SYSCR_RESERVE0_Msk
#define LPSYS_CFG_SYSCR_RESERVE1_Pos    (8U)
#define LPSYS_CFG_SYSCR_RESERVE1_Msk    (0xFFUL << LPSYS_CFG_SYSCR_RESERVE1_Pos)
#define LPSYS_CFG_SYSCR_RESERVE1        LPSYS_CFG_SYSCR_RESERVE1_Msk
#define LPSYS_CFG_SYSCR_RESERVE2_Pos    (16U)
#define LPSYS_CFG_SYSCR_RESERVE2_Msk    (0xFFUL << LPSYS_CFG_SYSCR_RESERVE2_Pos)
#define LPSYS_CFG_SYSCR_RESERVE2        LPSYS_CFG_SYSCR_RESERVE2_Msk
#define LPSYS_CFG_SYSCR_RESERVE3_Pos    (24U)
#define LPSYS_CFG_SYSCR_RESERVE3_Msk    (0xFFUL << LPSYS_CFG_SYSCR_RESERVE3_Pos)
#define LPSYS_CFG_SYSCR_RESERVE3        LPSYS_CFG_SYSCR_RESERVE3_Msk
...
/***************** Bit definition for LPSYS_CFG_MCR register ******************/
#define LPSYS_CFG_MCR_RAM_RM_Pos        (0U)
#define LPSYS_CFG_MCR_RAM_RM_Msk        (0x3UL << LPSYS_CFG_MCR_RAM_RM_Pos)
#define LPSYS_CFG_MCR_RAM_RM            LPSYS_CFG_MCR_RAM_RM_Msk
#define LPSYS_CFG_MCR_RAM_RME_Pos       (4U)
#define LPSYS_CFG_MCR_RAM_RME_Msk       (0x1UL << LPSYS_CFG_MCR_RAM_RME_Pos)
#define LPSYS_CFG_MCR_RAM_RME           LPSYS_CFG_MCR_RAM_RME_Msk
#define LPSYS_CFG_MCR_RAM_RA_Pos        (5U)
#define LPSYS_CFG_MCR_RAM_RA_Msk        (0x3UL << LPSYS_CFG_MCR_RAM_RA_Pos)
#define LPSYS_CFG_MCR_RAM_RA            LPSYS_CFG_MCR_RAM_RA_Msk
#define LPSYS_CFG_MCR_RAM_WA_Pos        (7U)
#define LPSYS_CFG_MCR_RAM_WA_Msk        (0x7UL << LPSYS_CFG_MCR_RAM_WA_Pos)
#define LPSYS_CFG_MCR_RAM_WA            LPSYS_CFG_MCR_RAM_WA_Msk
#define LPSYS_CFG_MCR_RAM_WPULSE_Pos    (10U)
#define LPSYS_CFG_MCR_RAM_WPULSE_Msk    (0x7UL << LPSYS_CFG_MCR_RAM_WPULSE_Pos)
#define LPSYS_CFG_MCR_RAM_WPULSE        LPSYS_CFG_MCR_RAM_WPULSE_Msk
#define LPSYS_CFG_MCR_ROM_RM_Pos        (16U)
#define LPSYS_CFG_MCR_ROM_RM_Msk        (0x3UL << LPSYS_CFG_MCR_ROM_RM_Pos)
#define LPSYS_CFG_MCR_ROM_RM            LPSYS_CFG_MCR_ROM_RM_Msk
#define LPSYS_CFG_MCR_ROM_RME_Pos       (20U)
#define LPSYS_CFG_MCR_ROM_RME_Msk       (0x1UL << LPSYS_CFG_MCR_ROM_RME_Pos)
#define LPSYS_CFG_MCR_ROM_RME           LPSYS_CFG_MCR_ROM_RME_Msk
...
#define LPSYS_CFG_BISTR_BIST_FAIL_ROM_Msk  (0x7FUL << LPSYS_CFG_BISTR_BIST_FAIL_ROM_Pos)
#define LPSYS_CFG_BISTR_BIST_FAIL_ROM   LPSYS_CFG_BISTR_BIST_FAIL_ROM_Msk
#define LPSYS_CFG_BISTR_BIST_FAIL_RAM_Pos  (7U)
...
#define LPSYS_CFG_BISTR_BIST_FAIL_RFC_Pos  (9U)
...
#define LPSYS_CFG_ROMCR6_SIG_Pos        (0U)
#define LPSYS_CFG_ROMCR6_SIG_Msk        (0xFFFFFFFFUL << LPSYS_CFG_ROMCR6_SIG_Pos)
#define LPSYS_CFG_ROMCR6_SIG            LPSYS_CFG_ROMCR6_SIG_Msk
