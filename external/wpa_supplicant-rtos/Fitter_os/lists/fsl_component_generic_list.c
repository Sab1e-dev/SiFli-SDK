...
#else
#define LIST_ENTER_CRITICAL() uint32_t regPrimask = rt_hw_interrupt_disable(0);//DisableGlobalIRQ();
#define LIST_EXIT_CRITICAL()  rt_hw_interrupt_enable(regPrimask);//EnableGlobalIRQ(regPrimask);
#endif
#else
#define LIST_ENTER_CRITICAL() 1//rt_base_t  regPrimask = rt_hw_interrupt_disable(0);//DisableGlobalIRQ();
#define LIST_EXIT_CRITICAL()  1//rt_hw_interrupt_enable(regPrimask);//EnableGlobalIRQ(regPrimask);
#endif
