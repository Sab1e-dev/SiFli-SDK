...
#define kStatusGroup_Generic (0x00U) /*!< Generic status group. */
#define kStatusGroup_LIST    (0x01U) /*!< List status group. */
#define kStatusGroup_OSA     (0x02U) /*!< OSA status group. */
#define kStatusGroup_BM      (0x03U) /*!< BM status group. */
#define kStatusGroup_MQX     (0x04U) /*!< MQX status group. */
#define kStatusGroup_RTOS    (0x05U) /*!< RTOS status group. */
#define kStatusGroup_FREERTOS (0x06U) /*!< FreeRTOS status group. */
