...
/*
根据当前要连接的网络（struct wpa_ssid *ssid）的配置，填充并设置 RSN/WPA 状态机（wpa_sm）的安全参数。
它负责把 SSID 配置中的加密、认证、EAP、P2P、FILS 等相关参数，整理成 struct rsn_supp_config，
并通过 wpa_sm_set_config 应用到 WPA/RSN 协议状态机中
*/
